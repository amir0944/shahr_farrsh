...
box-shadow: 2px 2px 50px gray;margin: 40px 220px 40px 220px;">
            ...
            <input type="text" placeholder="نام محصول..." name="pname"style="width: 900px; height: 50px; margin:10px; direction: rtl;" value="<?php echo $row['product_name'];?>"><br>
            <input type="text" placeholder="قیمت محصول..." name="pprice"style="width: 900px; height: 50px; margin:10px; direction: rtl;" value="<?php echo $row['product_price'];?>"><br>
            <textarea name="pdesc" placeholder="توضیحات محصول..."style="width: 900px; height: 50px; margin:10px; direction: rtl;" value="<?php echo $row['product_desc'];?>"></textarea><br>
            <input type="file" name="pimage"style="width: 900px; height: 50px; margin:10px; direction: rtl;color: white;"<?php echo $row['product_image'];?></inpu>><br>
            <input type="submit" value="بروزرسانی محصول" name="btnsave"style="width: 900px; height: 50px; margin:10px; direction: rtl;">
